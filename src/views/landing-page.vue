    ...
    <div class="landing-page-top-container">
      <nav data-role="Header" class="landing-page-navbar">
        ...
        <div class="landing-page-right-side">
          ...
          <a href="#main-section" class="landing-page-link">
            <solid-button button="Explore places"></solid-button>
          </a>
        </div>
        <div data-role="BurgerMenu" class="landing-page-burger-menu">
          <svg viewBox="0 0 1024 1024" class="landing-page-burger-menu1">
            <path
      ...
      <div class="landing-page-hero">
        <div class="landing-page-content-container">
          <h1 class="Heading landing-page-text09">Kinesitherapie</h1>
          <h2 class="Subheading landing-page-subheading">Riviereinhof</h2>
          <span class="landing-page-text10">
            <span>
              Each property is hand-picked,
              <span v-html="rawx59c"></span>
            </span>
            <br />
            <span>personally visited and cannot be found elsewhere.</span>
          </span>
          <solid-button button="Explore homes"></solid-button>
        </div>
      </div>
    </div>
    ...
    <div class="landing-page-footer">
      <div class="landing-page-menu">
        ...
        <div class="landing-page-follow-container1">
          <span class="landing-page-text16">
            Follow us on
            <span v-html="raw2nqk"></span>
          </span>
...
.landing-page-hero {
  ...
  background-size: cover;
  justify-content: space-between;
  background-image: url("/360_f_501286262_60hc70bxbbkuloc4jdcbzfy8b942svtx-1000w.jpg");
}
